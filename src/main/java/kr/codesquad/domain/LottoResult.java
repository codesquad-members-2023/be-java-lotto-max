...
public class LottoResult {
    ...
    LottoResult(int rank, int lotto, int bonus, int reward) {
        this.rank = rank;
        this.lotto = lotto;
        this.bonus = bonus;
        this.reward = reward;
    ...
    public static void calcRank(long price, List<Lotto> lottos, List<Integer> winningLotto, int bonus) {
        ...
        for(Lotto lotto : lottos) {
            LottoResult curRank = matchLotto(lotto, winningLotto, bonus);
            ranks[curRank.rank]++;
    ...
    public static LottoResult matchLotto(Lotto lotto, List<Integer> winningLotto, int bonus) {
